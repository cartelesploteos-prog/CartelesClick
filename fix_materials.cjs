...
finalCode = finalCode.replace(/applicableCategories: \["lonas", "vinilos", "rigidos"\]/g, 'applicableCategories: ["gigantografias", "carteles"]');
finalCode = finalCode.replace(/applicableCategories: \["lonas", "vinilos", "estampados"\]/g, 'applicableCategories: ["gigantografias", "estampados"]');
finalCode = finalCode.replace(/applicableCategories: \["lonas", "estampados"\]/g, 'applicableCategories: ["gigantografias", "estampados"]');
finalCode = finalCode.replace(/applicableCategories: \["lonas"\]/g, 'applicableCategories: ["gigantografias", "carteles"]');
finalCode = finalCode.replace(/applicableCategories: \["lonas", "rigidos"\]/g, 'applicableCategories: ["gigantografias", "carteles"]');
finalCode = finalCode.replace(/applicableCategories: \["vinilos"\]/g, 'applicableCategories: ["gigantografias", "carteles"]');
finalCode = finalCode.replace(/applicableCategories: \["rigidos", "corporeos"\]/g, 'applicableCategories: ["carteles", "corporeos"]');

fs.writeFileSync('src/data/materials.ts', finalCode);
