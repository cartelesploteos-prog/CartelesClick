...
// Find the corresponding closing bracket for app.post
let depth = 0;
let endIdx = -1;
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  const finalContent = content.substring(0, startIdx) + newCode + content.substring(endIdx);
